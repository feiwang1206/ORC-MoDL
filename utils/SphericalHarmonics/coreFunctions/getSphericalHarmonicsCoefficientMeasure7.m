function [bc,bs] = getSphericalHarmonicsCoefficientMeasure7original(Bx,By,Bz,degreeMax,orderMax,rk,mode)
...
%                 end
        ...
        bc(2).coefficient(l+1,m+l+1) = sumBy_bc;
        bc(3).coefficient(l+1,m+l+1) = sumBz_bc;
        bs(1).coefficient(l+1,m+l+1) = sumBx_bs;
        bs(2).coefficient(l+1,m+l+1) = sumBy_bs;
        bs(3).coefficient(l+1,m+l+1) = sumBz_bs;
    end
end

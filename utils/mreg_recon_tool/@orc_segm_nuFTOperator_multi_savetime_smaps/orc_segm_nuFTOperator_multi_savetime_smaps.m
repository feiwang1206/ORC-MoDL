function  A = orc_segm_nuFTOperator_multi_savetime_smaps(s, sensmaps, wmap)
...
s.wi=kspace_precond(s1,s.sensmaps,s.lambda);

A = class(s,'orc_segm_nuFTOperator_multi_savetime_smaps');

function  A = orc_segm_nuFTOperator(trajectory, imageDim, sensmaps, wmap, dwelltime, Ns, DeltaT,kernel)
...
for k=1:Ns+1
    nstr = nufft_init_rm(trajectory(si{k},:), s.imageDim, s.nufftNeighbors, s.oversampling, s.imageDim/2, kernel);%, 'kaiser'

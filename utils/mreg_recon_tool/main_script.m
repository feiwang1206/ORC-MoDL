...
rawdata_path=pwd;
mreg_filename='meas_MID00624_FID03003_MREG.dat';%mreg rawdata file name, e.g. meas_MID00133_FID01338_MREG.dat
ref_filename='meas_MID00599_FID02978_gre_field_mapping.dat';%reference rawdata file name, e.g. meas_MID00100_FID01305_gre_field_mapping.dat
recon_path=pwd;%
...
% traj=loadTrajectory([mreg_path(1:(end-33)) 'grad_files/SoS_rev4_half_3625.grad'],[],[-3.7 -3 -3]);%trajectory files
traj=loadTrajectory(['SoS_rev4_half_3625.grad'],[],[-3.7 -3 -3]);%trajectory files

%% Set reconstruction parameters
[~,header]=loadData([rawdata_path '/' mreg_filename],1);
recon_details.recon_resolution=[64 64 64];%desired reconstrution spatial resolution

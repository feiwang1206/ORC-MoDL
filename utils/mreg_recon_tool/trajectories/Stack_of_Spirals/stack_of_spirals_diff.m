function T = stack_of_spirals_diff(R,Nradial,Nz,fov,resolution, xyz)
...
%%
maxg=0.03;
Td(1,iz,1).G=zeros(500,3);
Td(1,iz,1).G(1:50,xyz)=0:maxg/50:(maxg-maxg/50);
Td(1,iz,1).G(51:450,xyz)=maxg;
Td(1,iz,1).G(451:500,xyz)=(maxg-maxg/50):-maxg/50:0;
Td(1,iz,1).K=gamma*cumsum(Td(1,iz,1).G)*1e-5;
Td(2,iz,1).G=-Td(1,iz,1).G;
Td(2,iz,1).K=-Td(1,iz,1).K;

T0=T;

b=0;
T(1)=T0(1);
T(1).K=[b*Td(1).K;b*Td(2).K;T0(1).K];
T(1).G=[b*Td(1).G;b*Td(2).G;T0(1).G];
T(2)=T0(1);
T(2).K=[b*Td(1).K;b*Td(2).K;-T0(1).K];
T(2).G=[b*Td(1).G;b*Td(2).G;-T0(1).G];

b=0.1;
T(3)=T0(1);
T(3).K=[b*Td(1).K;b*Td(2).K;T0(1).K];
T(3).G=[b*Td(1).G;b*Td(2).G;T0(1).G];
T(4)=T0(1);
T(4).K=[b*Td(1).K;b*Td(2).K;-T0(1).K];
T(4).G=[b*Td(1).G;b*Td(2).G;-T0(1).G];

b=-0.1;
T(5)=T0(1);
T(5).K=[b*Td(1).K;b*Td(2).K;T0(1).K];
T(5).G=[b*Td(1).G;b*Td(2).G;T0(1).G];
T(6)=T0(1);
T(6).K=[b*Td(1).K;b*Td(2).K;-T0(1).K];
T(6).G=[b*Td(1).G;b*Td(2).G;-T0(1).G];

b=1;
T(7)=T0(1);
T(7).K=[b*Td(1).K;b*Td(2).K;T0(1).K];
T(7).G=[b*Td(1).G;b*Td(2).G;T0(1).G];
T(8)=T0(1);
T(8).K=[b*Td(1).K;b*Td(2).K;-T0(1).K];
T(8).G=[b*Td(1).G;b*Td(2).G;-T0(1).G];

b=-1;
T(9)=T0(1);
T(9).K=[b*Td(1).K;b*Td(2).K;T0(1).K];
T(9).G=[b*Td(1).G;b*Td(2).G;T0(1).G];
T(10)=T0(1);
T(10).K=[b*Td(1).K;b*Td(2).K;-T0(1).K];
T(10).G=[b*Td(1).G;b*Td(2).G;-T0(1).G];

function T = stack_of_spirals_reverse_axis(R,Nradial,Nz,fov,resolution)
...
% T(2).K(1:1000,1:3)=0;
% T(2).K(1001:(1000+length(T(1).K)),:)=-T(1).K;
% T(2).G(1:1000,:)=0;
% T(2).G(1001:(1000+length(T(1).G)),:)=-T(1).G;
% 
% T(1).K((end+1):(end+1000),:)=0;
% T(1).G((end+1):(end+1000),:)=0;
